...
# scientific record and is *itself* protected from `clean docs` even if
# nothing references its filename. Mirrors the style FINDINGS.md uses.
...
class ReferenceIndex:
    ...
    def references(self, basename: str) -> bool:
        ...
        for g in self.globs:
            ...
            #    appears in `basename`, treat it as a reference. This is
            #    what makes a finding-doc glob like
